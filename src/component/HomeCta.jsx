  ...
  return (
    <section className="relative px-6 mt-5 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto bg-gradient-to-br from-green-50 to-[#f0fdf4] p-8 sm:p-12 rounded-3xl shadow-lg border border-green-100">
        ...
        <div className="absolute bottom-6 left-6 text-green-200 text-5xl">
          🍃
        </div>
        ...
        <div className="relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold text-green-900 mb-6 leading-tight">
            Cultivate Your{" "}
            <span className="text-green-600">Plant Paradise</span> 🌿
          </h2>

          <p className="text-green-700 text-md md:text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
            Join our community of plant lovers and receive{" "}
            <span className="font-medium">
              hand-selected plants, expert care guides, and premium tools
            </span>{" "}
